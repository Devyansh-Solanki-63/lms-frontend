...
const EditCourse = () => {
    ...
    const onFormSubmit = async (e) => {
        ...
        const response = await dispatch(editCourse({...userInput, id: courseDetails?._id}));
                    ...
                    <main className="grid grid-cols-2 gap-x-10">
                        <div className="gap-y-6">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <input className="bg-transparent px-2 py-1 border"
                                    required
                                    type="text"
                                    name="title"
                                    id="title"
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <textarea className="bg-transparent px-2 py-1 h-24 overflow-y-scroll resize-none border"
                                    required
                                    type="text"
                                    name="description"
                                    id="description"
